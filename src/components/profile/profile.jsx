                    ...
                    {IsBigScreen ?
                        <div className="flex flex-row  h-1/2 p-1 sm:p-4">
                            <div className="sm:w-1/2 w-screen pl-16 ">
                                {user?.user?.image ?
                                    <img className="rounded-full  h-56 w-56 border-red-400 object-cover" src={user?.user?.image} alt="" />
                            ...
                            <div className="flex flex-col w-3/4 m-5 pl-9 ">
                                <div className="flex flex-row m-4">
                                    <div >
                                        <h1 className="mr-7 font-normal text-3xl cursor-default">{user?.user?.name}</h1>
                                    </div>
                        ...
                        <div className="flex flex-col  h-1/2 p-1 lg:p-5">
                            ...
                            <div className="flex flex-col w-3/4 m-5">
                                <div className="flex flex-row ">
                                    <div >
                                        <h1 className="mr-7 font-normal md:text-3xl text:xl ">{user?.user?.name}</h1>
                                    </div>
                                ...
                                return (
                                    <div key={i} className=" cursor-pointer grid justify-items-start group">
                                        <div className="justify-self-center min-w-80 min-h-80 max-h-80 max-w-80 relative">
                                            <img className='justify-self-center object-cover sm:h-80 h-[100px]  w-80 hover:opacity-25' src={e.image[0]?.url} alt="" />
