                    ...
                    {IsBigScreen ?
                        <div className="flex flex-row  h-1/2 p-1 sm:p-4">
                            ...
                            <div className="flex flex-col w-3/4 m-5 pl-9 ">
                                <div className="flex flex-row m-4">
                                    <div >
                                        <h1 className="mr-7 font-normal text-3xl cursor-default">{userDetails?.name}</h1>
                                    </div>
                                ...
                                <div className="flex flex-row  m-4" >
                                    ...
                                    <h1 className="mr-7  cursor-default" >followers {userDetails?.followers?.length}</h1>
                                    <h1 className=' cursor-default' >following  {userDetails?.following?.length}</h1>
                                </div>
                                <div className="flex flex-row  m-4">
                                    <p>{userDetails?.bio}
                                    </p>
                        ...
                        <div className="flex flex-col  h-1/2 p-1 lg:p-5">
                            ...
                            <div className="flex flex-col w-3/4 m-5">
                                ...
                                <div>
                                    <p className='cursor-default'>{userDetails?.bio}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="p-5 pb-14 grid grid-cols-1 md:grid-cols-3 gap-8 ">
                        {
                            post?.map((e, i) => {
                                return (
                                    <div key={i} className="cursor-default grid justify-items-start group">
