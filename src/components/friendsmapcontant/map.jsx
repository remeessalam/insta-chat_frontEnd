                ...
                Heading !== "Update profile picture" ?
                    ...
                    <div key={friends._id} className='flex flex-row p-3 items-center  justify-between w-full'>
                        <div className='flex flex-row items-center justify-start'>
                            ...
                            {
                                friends.image ?
                                    <img className='w-14 h-14 rounded-full object-cover' src={friends.image} alt={friends.name} />
                                    :
                    ...
                    <div className='cursor-pointer w-full mx-auto'>
                        <div className='' onClick={() => setprofilepic(friends.image[0]?.url)}>
                            <img className=' object-cover mx-auto h-24 w-24 hover:opacity-25 ' src={friends.image[0]?.url} alt="" />
                        </div>
                    </div>
            }
        </>
