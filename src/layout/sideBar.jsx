                ...
                {IsBigScreen ?
                    <div className='flex fixed border-r w-1/4  h-screen border-slate-300'>
                        ...
                        <div className='flex flex-col justify-between w-full p-5'>
                            <h1 className='font-adelia text-4xl text-center font-medium font-black'>Instachat</h1>
                            <Link to={'/'}>
                            ...
                            <div onClick={() => setOpen(true)} className='flex flex-row ml-8 items-center w-3/4  hover:bg-gray-100 rounded-full p-1  hover:scale-110  duration-300 '>
                                <div className='w-12 ml-4'>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10">
                            ...
                            <button className="flex px-4 py-2" onClick={logout}>sign-out</button>
                        </div>
                    </div> :
                    <div>
                        <div className='flex fixed bottom-0 w-full bg-gray-100 z-10 h-12'>
                            <div className='flex flex-row justify-around w-full '>
                                ...
                                <div className='flex  items-center' onClick={() => setSearch(!Search)}>
                                    {/* search */}
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-10 h-10">
                                ...
                                <Link to={'/profile'}>
                                    <div className='flex  items-center '>
                                        {image ? <img
                                            ...
                                            alt=""
                                        />
                                            : <svg className="rounded-full aspect-square" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 h-10">
                                                <path fill-rule="evenodd" d="M18.685 19.097A9.723 9.723 0 0021.75 12c0-5.385-4.365-9.75-9.75-9.75S2.25 6.615 2.25 12a9.723 9.723 0 003.065 7.097A9.716 9.716 0 0012 21.75a9.716 9.716 0 006.685-2.653zm-12.54-1.285A7.486 7.486 0 0112 15a7.486 7.486 0 015.855 2.812A8.224 8.224 0 0112 20.25a8.224 8.224 0 01-5.855-2.438zM15.75 9a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" clip-rule="evenodd" />
                                            </svg>}
                                    </div>
                                </Link>
